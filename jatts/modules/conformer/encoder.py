...
from jatts.modules.transformer.attention import (
    LegacyRelPositionMultiHeadedAttention,
    MultiHeadedAttention,
    RelPositionMultiHeadedAttention,
)
from jatts.modules.transformer.layer_norm import LayerNorm
from jatts.modules.transformer.multi_layer_conv import Conv1dLinear, MultiLayeredConv1d
from jatts.modules.transformer.positionwise_feed_forward import PositionwiseFeedForward
from jatts.modules.transformer.repeat import repeat
...
class Encoder(torch.nn.Module):
    ...
    def __init__(
        ...
        activation = Swish()  # Always use Swish
