...
ar_conf=conf/valle_ar.given.bs144.4gpus.yaml
nar_conf=conf/valle_nar.given.bs144.4gpus.yaml

# dataset configuration
# db_root=downloads
db_root=/data/group1/z44476r/Corpora/CSJ-7th
